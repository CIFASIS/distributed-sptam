...
//++++++++++++++++++++++++++++++++++++++++++++++++
// DSPTAM - creo una nueva funcion removeMeasurement para utilizarla en tracker tomando el KF y MP relacionados
    void removeMeasurement( SharedKeyFrame& kf, SharedPoint& mp)
     { graph_.removeMeasurement( kf, mp ); }

//++++++++++++++++++++++++++++++++++++++++++++++++


    inline SharedMapPointSet getLocalMap(/*const */sptam::Map::KeyFrame& keyFrame)
    { return graph_.getLocalMap( keyFrame ); }
