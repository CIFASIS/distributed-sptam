...
class LoopClosing
{
  public:
    ...
    void addKeyFrame(sptam::Map::KeyFrame& keyFrame);

    void addKeyFrames(const ConstIterable<sptam::Map::KeyFrame>& keyFrames);
  ...
  private:
    ...
    concurrent_queue<sptam::Map::KeyFrame*> keyFrameQueue_;
