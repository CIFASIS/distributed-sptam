...
class StereoMatcher
{
  public:
    ...
    static void match(const cv::DescriptorMatcher& matcher, double matchingDistanceThreshold,
                      const std::vector<cv::KeyPoint>& kps1, const cv::Mat& descriptors1, const std::vector<cv::KeyPoint>& kps2, const cv::Mat& descriptors2,
                      const std::vector<cv::KeyPoint>& kps3, const cv::Mat& descriptors3, const std::vector<cv::KeyPoint>& kps4, const cv::Mat& descriptors4,
