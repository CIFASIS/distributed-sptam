...
class PoseEstimator
{
  public:
    ...
    size_t estimatePose(const sptam::Map::KeyFrame& referenceFrame, const sptam::Map::KeyFrame& targetFrame, const std::vector<SDMatch>& stereo_matches, cv::Matx44d&);
  ...
  private:
    ...
    size_t centralPoseEstimation(const sptam::Map::KeyFrame&, const sptam::Map::KeyFrame&, const std::vector<SDMatch>&, cv::Matx44d&);
    /*Matx44d noncentralPoseEstimation(const StereoFrame&, const StereoFrame&, const std::vector<SDMatch>&);*/

    opengv::points_t triangulateReferencePoints(const sptam::Map::KeyFrame&, const std::vector<SDMatch>&);
};
