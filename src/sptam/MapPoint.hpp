...
//++++++++++++++++++++++++++++++++++++++++++++++
// DSPTAM - Agrego constructor sobrecargado con parametro id
    MapPoint(const Eigen::Vector3d& position, const Eigen::Vector3d& normal, const cv::Mat& descriptor, const Eigen::Matrix3d& covariance, size_t id);
//----------------------------------------------
...
//++++++++++++++++++++++++++++++++++++++++++++++
//## DSPTAM - nueva funcion para obtener id de MP
        inline size_t getMapPointId() const
        { return mapPoint_id_; }
//++++++++++++++++++++++++++++++++++++++++++++++
