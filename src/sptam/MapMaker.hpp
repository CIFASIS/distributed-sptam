...
class MapMaker
{
  public:
    ...
    inline void pause(){}
    inline void resume(){}
    inline bool isPauseRequested(){return false;}
...
//++++++++++++++++++++++++++++++++++++++++++++++++
// DSPTAM - lista de Measurements a eliminar identificados por el id (idKF, idMP)
    std::list<std::pair<size_t, size_t>> idMeasToDelete; 
//++++++++++++++++++++++++++++++++++++++++++++++++
};
