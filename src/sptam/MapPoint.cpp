...
//++++++++++++++++++++++++++++++++++++++++++++++
//## DSPTAM - Agrego constructor sobrecargado con parametro id y modifico constructor original
...
{
  MapPoint( position, normal, descriptor, covariance, -1);  
}
MapPoint::MapPoint(const Eigen::Vector3d& position, const Eigen::Vector3d& normal, const cv::Mat& descriptor, const Eigen::Matrix3d& covariance, size_t id)
  : position_( position )
...
//++++++++++++++++++++++++++++++++++++++++++++++
//## DSPTAM - Agrego mapPoint_id_ al constructor por copia
, mapPoint_id_ ( mapPoint.mapPoint_id_) 
//++++++++++++++++++++++++++++++++++++++++++++++
{
