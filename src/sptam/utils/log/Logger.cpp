...
//++++++++++++++++++++++++++++++++++++++++++++++
// DSPTAM - guardo logs en /tmp/
  filename_stream << "/tmp/dsptam_" <<  boost::posix_time::second_clock::local_time() << ".log"; // ORIGINAL: filename_stream << boost::posix_time::second_clock::local_time() << ".log";
//++++++++++++++++++++++++++++++++++++++++++++++
