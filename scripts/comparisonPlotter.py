...
def __computeRotationError__(error_poses):
  """
...
def __computeAbsoluteTranslationError__(position1, position2):
  ...
  translation_error = np.linalg.norm(position2 - position1, axis=1)
...
def plotErrorsByAxis(timestamps, errors, title, xlabel="", ylabels=""):
